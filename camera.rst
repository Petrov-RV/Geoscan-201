...
Для параметра ISO установите значение ISO Auto и диапазон 100 – 1600. это все надо запихнуть в табличку (давай везде одного стиля придерживаться: есть лупим таблички, то - везде)
